...
def compute_reward(robot, obs1, obs2, params, dt_outer):
    ...
    for i in range(H):
        ...
        control_ref = traced_unicycle_nominal_input_jit( states[i], robot.goal_torch )
        A, b = traced_unicycle2D_qp_constraints_jit( states[i], robot.goal_torch, obs1.X_torch, obs2.X_torch, params[0], params[1], params[2] )
        ...
        reward = reward + traced_unicycle_compute_reward_jit( states[i+1], robot.goal_torch, control )       
