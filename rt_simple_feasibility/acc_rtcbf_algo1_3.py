...
for t in range(T):
    ...
    if alpha2_cp.value[1,0] > alpha12_nom+0.1:
        alpha2_ref_cp.value[1,0] = alpha2_cp.value[1,0] - 0.1
    elif alpha2_cp.value[1,0] < alpha12_nom-0.1:
        alpha2_ref_cp.value[1,0] = alpha2_cp.value[1,0] + 0.1
        
    if alpha2_cp.value[2,0] > alpha21_nom+0.1:
        alpha2_ref_cp.value[2,0] = alpha2_cp.value[2,0] - 0.1
    elif alpha2_cp.value[2,0] < alpha21_nom-0.1:
        alpha2_ref_cp.value[2,0] = alpha2_cp.value[2,0] + 0.1
        
    if alpha2_ref_cp.value[2,0] < alpha21_nom:
        print(f"Hello error")
        
    if alpha2_cp.value[3,0] > alpha31_nom+0.1:
        alpha2_ref_cp.value[3,0] = alpha2_cp.value[3,0] - 0.1
    elif alpha2_cp.value[3,0] < alpha31_nom-0.1:
        alpha2_ref_cp.value[3,0] = alpha2_cp.value[3,0] + 0.1
...
fig3.savefig('acc_vel.png')
fig3.savefig('acc_vel.eps')
...
fig7.savefig('acc_input.png')
fig7.savefig('acc_input.eps')

fig4, ax4 = plt.subplots()
ax4.plot(ts, hs, 'k', label='barrier function')
ax4.legend()

fig4.savefig('acc_barrier.png')
fig4.savefig('acc_barrier.eps')
...
fig5.savefig('acc_alpha1.png')
fig5.savefig('acc_alpha1.eps')

fig6, ax6 = plt.subplots()
ax6.plot(ts, alpha12s, 'k', label='alpha12')
ax6.legend()

fig6.savefig('acc_alpha2.png')
fig6.savefig('acc_alpha2.eps')
